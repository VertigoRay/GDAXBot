...
function coin (product_id, data) {
	...
	if (data.bot) {
		let ticker_label = `Ticker length (${typeof data.ticker}): `;
		options.x = 1;
		options.y = 5;
		options.attr = theme.coins.label;
		...
		options.attr = theme.coins.standard;
		b_coin_pid.put(options, String(data.ticker.length));


		let myorders_label = `My Orders length (${typeof data.myorders}): `;
		options.x = 1;
		options.y = 6;
		options.attr = theme.coins.label;
		...
		options.attr = theme.coins.standard;
		b_coin_pid.put(options, String(data.myorders.length));


		let last_price_label = `My Orders length (${typeof data.last_price}): `;
		options.x = 1;
		options.y = 7;
		options.attr = theme.coins.label;
		...
		options.attr = theme.coins.standard;
		b_coin_pid.put(options, String(data.last_price.length));


		let midmarket_price_label = `My Orders length (${typeof data.midmarket_price}): `;
		options.x = 1;
		options.y = 8;
		options.attr = theme.coins.label;
		...
		options.attr = theme.coins.standard;
		b_coin_pid.put(options, String(data.midmarket_price.length));


		let orderbook_label = `My Orders length (${typeof data.orderbook}): `;
		options.x = 1;
		options.y = 9;
		options.attr = theme.coins.label;
		...
		options.attr = theme.coins.standard;
		b_coin_pid.put(options, String(data.orderbook.length));


		let synced_book_label = `My Orders length (${typeof data.synced_book}): `;
		options.x = 1;
		options.y = 10;
		options.attr = theme.coins.label;
		...
		options.attr = theme.coins.standard;
		b_coin_pid.put(options, String(data.synced_book.length));
	}
